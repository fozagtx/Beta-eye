(function (root) {
  ...
  function collectReadableText(rootNode) {
    ...
    return elements
      ...
      .map((element) => ({ element, text: element.textContent.trim(), hash: hashText(element.textContent) }));
  }
  ...
  root.SeeChunker = { collectReadableText, isMeaningful, hashText };
  if (typeof module !== "undefined") module.exports = root.SeeChunker;
