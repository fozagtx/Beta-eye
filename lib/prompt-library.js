(function (root) {
  ...
  const PROMPT_VERSION = "beta-eye-prompts-v2.0.0";
  const MODES = {
  ...
  root.BetaEyePromptLibrary = { PROMPT_VERSION, buildPrompt, parseAiResponse };
  if (typeof module !== "undefined") module.exports = root.BetaEyePromptLibrary;
